...
"font: 75 10pt \"Verdana\";")
        ...
        self.inputdoc.setGeometry(QtCore.QRect(70, 130, 113, 20))
        self.inputdoc.setStyleSheet("border-color: rgb(0, 85, 255);")
        self.inputdoc.setObjectName("input")

        self.inputend = QtWidgets.QLineEdit(Dialog)
        self.inputend.setGeometry(QtCore.QRect(70, 160, 113, 20))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Documento"))
        self.label_4.setText(_translate("Dialog", "Endereço"))
        ...
        self.inputdoc.setPlaceholderText(_translate("Dialog", "Documento"))
        self.inputend.setPlaceholderText(_translate("Dialog", "Endereço"))

import img_py.cadastroimg
